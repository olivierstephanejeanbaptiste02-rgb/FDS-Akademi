...
export default function Login() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      // Modification de la ligne ci-dessous pour utiliser l'URL de production
      ...
      console.error(err);
      setErrorMsg("Impossible de joindre le service d'authentification. Veuillez réessayer ultérieurement.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
        ...
        {/* Affichage dynamique des alertes d'erreurs */}
        {errorMsg && (
